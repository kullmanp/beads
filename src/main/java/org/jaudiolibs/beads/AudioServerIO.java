...
public abstract class AudioServerIO extends AudioIO implements AudioClient {
    ...
    public void configure(AudioConfiguration ac) {
    ...
    public static class Jack extends AudioServerIO {
        ...
        protected boolean start() {
            ...
            config = new AudioConfiguration(
                    ...
                    true);
            try {
                server = new JackAudioServerProvider().createServer(config, this);
            } catch (Exception e) {
                throw new RuntimeException("Error starting up jack audio provider", e);
            }
            return runThread();
        }
    }
    ...
    public static class JavaSound extends AudioServerIO {
        ...
        protected boolean start() {
            ...
            config = new AudioConfiguration(
                    ...
                    true);
            try {
                server = new JSAudioServerProvider().createServer(config, this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return runThread();
