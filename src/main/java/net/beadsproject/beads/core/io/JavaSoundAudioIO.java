...
public class JavaSoundAudioIO extends AudioIO {
    ...
    public void chooseMixerCommandLine() {
        ...
        try {
            selectMixer(AudioSystem.getMixerInfo()[Integer.parseInt(br.readLine()) - 1]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     *
     * @param mixerInfo the requested mixer or null for the default mixer
     */
    public void selectMixer(Mixer.Info mixerInfo) {
